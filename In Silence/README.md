![In Silence](https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1361000/header.jpg)  
# In Silence
Only works with v1.01.
...
- Voice chat doesn't work.
  - Game uses Vivox for Voice, which uses their own servers and therefore doesn't work offline.
